        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-uppercase mb-0 text-center">나의 주문 내역</h5>
                        </div>
                        <div class="table-responsive">
                            <table class="table no-wrap user-table custom-table mb-0 text-center">
                                <thead>
                                <tr scope="row">
                                    <th scope="col" class="border-0">주문 번호</th>
                                    <th scope="col" class="border-0">주문 상품</th>
                                    <th scope="col" class="border-0">주문 상품</th>
                                    <th scope="col" class="border-0">주문 상품</th>
                                ...
                                <c:choose>
                                    <c:when test="${!empty deliveryList}">
                                        <c:forEach items="${deliveryList}" var="list" varStatus="i">
                                            <tr style="cursor:pointer;" onclick="window.location.href='/community/view?type=qna&idx=${list.pay_idx}'">
<%--                                                <td class="pl-4">${fn:length(deliveryList) - i.index}</td>--%>
                                                <td>${list.pay_idx}</td>
