...
<head>
    ...
    <title>community >> qnaModify</title>
        ...
        <div class="container" style="margin-bottom: 5rem;">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase mb-0 text-center">QnA 수정</h5>
                            </div>
                                    ...
                                    <div>
                                        <table class="table no-wrap user-table mb-0 text-lg-start">
                                            ...
                                            <tr class="table-light">
                                                ...
                                                <td><input type="text" name="reg_date" id="reg_date" class="form-control" value="${qnaDTO.reg_date}" readonly/></td>
                                            </tr>
                                        </table>
                                    </div>
                        ...
                        <div class="mt-md-2">
                            <div>
                                ...
                                <button type="button" class="btn btn-outline-danger me-2" onclick="location.href='/community/view?type=qna&idx=${qnaDTO.idx}'">취소</button>
                            </div>
                        </div>
                    </form>
                </div>
