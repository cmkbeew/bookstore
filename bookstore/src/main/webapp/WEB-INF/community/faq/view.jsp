    ...
    <div id="page-content-wrapper">
        ...
        <div class="container py-h">
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 4px;">
                <div>
                    <button type="button" class="btn btn-outline-primary btn-circle btn-lg btn-circle" onclick="location.href='/community/faq/list'"><i class="fa fa-list"></i></button>
                </div>
            </div>
            <div class="card mt-5">
                <table class="table no-wrap user-table mb-0 text-lg-start">
                    <tr>
                        ...
                        <c:if test="${faqPrevDTO != null}">
                            <td><a href="/community/faq/view?faq_idx=${faqPrevDTO.faq_idx}">${faqPrevDTO.title}</a></td>
                        </c:if>
                        <c:if test="${faqPrevDTO == null}">
                            <td>이전글이 없습니다.</td>
                        </c:if>
                    ...
                    <tr>
                        ...
                        <c:if test="${faqNextDTO != null}">
                            <td><a href="/community/faq/view?faq_idx=${faqNextDTO.faq_idx}">${faqNextDTO.title}</a></td>
                        </c:if>
                        <c:if test="${faqNextDTO == null}">
                            <td>다음글이 없습니다.</td>
                        </c:if>
