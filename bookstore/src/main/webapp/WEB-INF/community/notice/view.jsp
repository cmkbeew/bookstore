    ...
    <div id="page-content-wrapper">
        ...
        <div class="container py-h">
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 4px;">
                <div>
                    <button type="button" class="btn btn-outline-primary btn-circle btn-lg btn-circle"><i class="fa fa-list"></i></button>
                </div>
            </div>
            <div class="card mt-5">
                <table class="table no-wrap user-table mb-0 text-lg-start">
                    <tr>
                        ...
                        <td><a href="/community/notice/view?notice_idx=${noticeDTO.notice_idx - 1}">이전글 타이틀</a></td>
                    </tr>
                    <tr>
                        <th style="width: 120px;">
                        ...
                        <td><a href="/community/notice/view?notice_idx=${noticeDTO.notice_idx + 1}">다음글 타이틀</a></td>
                    </tr>
                </table>
            </div>
        </div>
