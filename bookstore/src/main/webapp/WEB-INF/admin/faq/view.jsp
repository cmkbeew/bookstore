    ...
    <div id="page-content-wrapper" style="min-height: 80vh;">
        ...
        <div class="container">
            <form name="deleteFrm" id="deleteFrm" method="post" action="/admin/faq/delete">
                ...
                <div class="mt-md-2">
                    <div>
                        <button type="button" class="btn btn-primary btn-circle btn-lg btn-circle ml-2" onclick="location.href='/admin/list?type=faq';"><span class="material-symbols-outlined">list</span></button>
                        <button type="button" class="btn btn-primary btn-circle btn-lg btn-circle ml-2" onclick="location.href='/admin/faq/modify?idx=${faqDTO.idx}';"><span class="material-symbols-outlined">edit_note</span></button>
                        <button type="submit" class="btn btn-primary btn-circle btn-lg btn-circle ml-2" onclick="goDelete()"><span class="material-symbols-outlined">delete</span></button>
                    </div>
                </div>
            </form>
            <div class="card my-5">
