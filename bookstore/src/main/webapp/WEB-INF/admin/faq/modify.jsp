                                    ...
                                    <div>
                                        <table class="table no-wrap user-table mb-0 text-lg-start">
                                            <tr class="table-light">
                                                <th style="width: 120px; vertical-align: middle">제목<span class="material-symbols-outlined web_font">title</span></th>
                                                <td>
                                            ...
                                            <tr class="table-light">
                                                <th style="vertical-align: middle;">작성자<span class="material-symbols-outlined web_font">face</span></th>
