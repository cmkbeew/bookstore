...
<div class="container-md mt-3 py-h">
    <h1 style="text-align: center">도서 후기 수정</h1>
    <form name="frmModify" id="frmModify" method="post" action="/product/review/modify">
        <input type="hidden" name="type" id="type" value="${type}" />
        <input type="hidden" name="product_idx" id="product_idx" value="${reviewDTO.product_idx}" />
        <input type="hidden" name="review_idx" id="review_idx" value="${reviewDTO.review_idx}" />
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="writer" name="writer" value="${reviewDTO.writer}" readonly />
        ...
        <div class="mb-3">
            ...
            <p class="ratings">
                <input class="form-control text-center me-3" name="grade" id="grade" type="number" value="${reviewDTO.grade}" min="1" max="5" style="max-width: 5rem;" />
        ...
        <div class="d-grid gap-2">
            ...
            <button class="btn btn-secondary" type="button" onclick="location.href='/product/view?type=${type}&product_idx=${reviewDTO.product_idx}#bookReview'">뒤로가기</button>
        </div>
    </form>
</div>
<script>
